    ...
    return (
      <main className="min-h-screen bg-gray-100 flex items-center justify-center text-center p-4">
        <div>
          ...
          <p className="text-xl text-gray-600">You haven&apos;t selected any colleges to compare yet.</p>
          <Link
            href="/colleges"
            className="mt-6 inline-block bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-zinc-800"
          >
            Browse Colleges
          </Link>
        </div>
    ...
    <main className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-3">
          <h1 className="text-4xl font-bold text-center">College Comparison</h1>
          <button
            type="button"
            onClick={clearCompare}
            className="rounded-md bg-zinc-800 px-4 py-2 text-sm font-semibold text-white hover:bg-black"
          >
            Clear Comparison
          </button>
        </div>
            ...
            <div key={college.id} className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center h-full">
              ...
              <div className="flex flex-col flex-grow w-full">
                ...
                <div className="w-full text-left space-y-2 mb-4 border-t pt-4">
                  ...
                  <p>
                    <strong>Fees:</strong> Rs. {college.fees.toLocaleString()}
                  </p>
                  <p>
